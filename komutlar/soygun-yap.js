...
const soyguncu = prosoyguncu[Math.floor(Math.random() * prosoyguncu.length)];
  ...
  function(i){
    ...
    .setDescription('---------')
      ...
      .setFooter(`${message.author.tag} Bir soygun yaptı.`)
      .setTimestamp()
    .setColor('RANDOM')
    )
  })
...
exports.conf = {
  ...
  aliases: ['soygun',"soygunyap"],//Komutun farklı kullanımları ÖR: !ping, !p
  permLevel: 0, //kimlerin kullanabileceğini  (bot.js dosyasında perm leveller yazıyor)
  kategori: "eğlence"
};

exports.help = {
  name: 'soygun-yap',//Komutun adı (Komutu girerken lazım olucak)
  description: 'Soygun Yaparsınız',//Komutun Açıklaması
  usage: 'soygun-yap' //komutun kullanım şekli; ÖR: !ban @Kullanıcı
}