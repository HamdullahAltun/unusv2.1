...
exports.run = async (client, message, args) => {
  ...
  this.games = new Set();
  if(this.games.has(message.channel.id)) await message.reply('Kanal başına sadece bir tahmin oyunu meydana gelebilir.');
...
exports.conf = {
  enabled: true,
  guildOnly: true,
  aliases: ['sayıtahmini', 'sayıtahmin', 'sayı-tahmini','sayıtahminoyunu'],
kategori: "eğlence",
  permLevel: 0
};
exports.help = {
